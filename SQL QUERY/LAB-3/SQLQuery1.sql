...
UPDATE DEPOSIT SET BNAME = 'NEHRUPLACE' WHERE CNAME = 'MEHUL'
...
UPDATE DEPOSIT SET ADATE = 95-04-01 WHERE CNAME = 'ANIL'

--9. Update the amount of MINU to 10000. (Use Deposit Table)
UPDATE DEPOSIT SET AMOUNT = 10000 WHERE CNAME = 'MINU'

--10. Update deposit amount of PRAMOD to 5000 and ADATE to 1-4-96 (Use Deposit Table)
UPDATE DEPOSIT SET AMOUNT = 5000,ADATE = 96-04-01 WHERE CNAME = 'PRAMOD'
